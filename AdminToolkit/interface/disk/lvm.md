...
/dev/sda6  vg-mx500-1 lvm2 a--  <750,00g <270,00g
/dev/sda7  vg-scratch lvm2 a--   292,96g  142,96g

pvs --segment
PV         VG         Fmt  Attr PSize    PFree    Start  SSize
/dev/sda6  vg-mx500-1 lvm2 a--  <750,00g <270,00g      0  12800
/dev/sda6  vg-mx500-1 lvm2 a--  <750,00g <270,00g  12800 110080
/dev/sda6  vg-mx500-1 lvm2 a--  <750,00g <270,00g 122880  69119
/dev/sda7  vg-scratch lvm2 a--   292,96g  142,96g      0  25600
/dev/sda7  vg-scratch lvm2 a--   292,96g  142,96g  25600  12800
/dev/sda7  vg-scratch lvm2 a--   292,96g  142,96g  38400  36599

vgs
VG         #PV #LV #SN Attr   VSize    VFree
vg-mx500-1   1   2   0 wz--n- <750,00g <270,00g
vg-scratch   1   2   0 wz--n-  292,96g  142,96g

lvs
LV    VG         Attr       LSize   Pool Origin Data%  Meta%  Move Log Cpy%Sync Convert
home  vg-mx500-1 -wi-ao---- 430,00g
root  vg-mx500-1 -wi-ao----  50,00g
cache vg-scratch -wi-ao----  50,00g
data  vg-scratch -wi-ao---- 100,00g

lvs --segment
LV    VG         Attr       #Str Type   SSize
home  vg-mx500-1 -wi-ao----    1 linear 430,00g
root  vg-mx500-1 -wi-ao----    1 linear  50,00g
cache vg-scratch -wi-ao----    1 linear  50,00g
data  vg-scratch -wi-ao----    1 linear 100,00g
```
...
```
  ...
  ---------------------
    ...
    mirror_log                  - For mirrors, the LV holding the synchronization log.
    mirror_log_uuid             - For mirrors, the UUID of the LV holding the synchronization log.
    ...
    writecache_block_size       - The writecache block size
  ...
  -----------------------------------
    ...
    writecache_total_blocks     - Total writecache blocks.
    writecache_free_blocks      - Total writecache free blocks.
    writecache_writeback_blocks - Total writecache writeback blocks.
    writecache_error            - Total writecache errors.
  ...
  -----------------------------
    ...
    integrity_settings          - Integrity settings.
    ...
    vdo_max_discard             - Maximum discard size volume can receive (vdopool).
    vdo_header_size             - Header size at front of vdopool.
    vdo_use_metadata_hints      - Deprecated use of REQ_SYNC for writes (vdopool).
    vdo_write_policy            - Deprecated write policy (vdopool).
